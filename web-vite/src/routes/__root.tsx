...
import { LandingAccordion } from '../components/accordion';
import "../index.css";

export const Route = createRootRoute({
  component: () => (
    <main className='bg-sotex-black-900'>
      <nav className="p-12">
        <img className="m-auto" alt={"SotexBox Logo"} height={60} width={240} src={"/sotex_box.svg"} />
      </nav>
      ...
      <section className="p-2 flex-col justify-center items-center relative pb-40 mb-20">
        ...
        <div className="flex flex-row justify-center items-center gap-4 text-white pt-4 pb-16 lg:pb-32">
          <a href="#get" className="py-3 px-6 border-[1px] border-white rounded-3xl flex gap-1 justify-center">
            <img height={20} width={20} src={"/tick.svg"} alt="Kvačica" />
            <span>Pogodnosti</span>
          </a>
          <a href="#connect" className="py-3 px-6 bg-sotex-purple-50 rounded-3xl flex gap-1 justify-center">
            <span>Kontakt</span>
            <img height={20} width={20} src={"/arrow_right.svg"} alt="Kvačica" />
          </a>
        </div >

        <img className="absolute bottom-0 left-0 z-[-1] w-full h-80 opacity-80" height={390} width={390} src={"/lights_1.png"} alt="Svetla" />
        <img className="absolute bottom-0 left-0 right-0 mx-auto translate-y-2/4 h-72 sm:h-96 sm:w-[400px] md:h-96 md:w-[500px] lg:w-[960px] lg:h-[550px]" height={1200} width={1200} src={"/tv.png"} alt="Svetla" />
      </section>
      ...
      <section className="p-4 lg:pt-12 lg:pb-24">
        ...
        <div className="lg:flex flex-row justify-center items-start gap-8 max-w-5xl m-auto">
          ...
          <img className="py-8 flex-1 lg:py-0 m-auto" height={400} width={400} src={"/splash_1.png"} alt="Box slika." />
        </div>
      </section>
      ...
      <footer className="p-4 relative flex flex-col justify-center items-center py-12">
        <div className="max-w-5xl m-auto flex flex-col justify-center items-center w-full lg:flex-row lg:justify-between lg:items-start">
          <div className="flex flex-col items-start justify-center">
            <img className="" src={"/sotex_box.svg"} height={24} width={264} alt="SotexBox logo." />
            <div className="flex flex-row gap-2 justify-start items-center py-8">
              ...
              <img className="h-12 w-24" src={"/sotex_solutions.svg"} height={20} width={264} alt="Sotex Solutions logo." />
            </div>
            <img className="py-8 hidden lg:block" height={300} width={300} src={"/splash_2.png"} alt="Box slika." />
        ...
        <img className="py-8 lg:hidden" height={300} width={300} src={"/splash_2.png"} alt="Box slika." />
        <span className="text-slate-300 whitespace-nowrap m-auto w-fit lg:hidden">© 2024 SotexBOX. Sva prava zadržana.</span>

        <img className="absolute bottom-0 left-0 z-[-1] w-full h-80 opacity-80" height={390} width={390} src={"/lights_2.png"} alt="Svetla" />
  ...
  return (
    <div className="flex flex-col justify-start max-w-lg items-start p-4 gap-4 border-[1px] border-b-0 border-sotex-black-450 last:border-b-[1px] first:rounded-t-2xl lg:border-b-[1px] lg:flex-1 lg:rounded-2xl hover:shadow-lg hover:shadow-neutral-900 transition-all ease-in-out duration-500">
      <div className="flex flex-row justify-between items-start w-full">
        <img className="h-14 w-14" src={icon} alt={header} height={56} width={56} />
        {note ?
